 ...
 */
public class StandardTokenizer extends com.lucene.analysis.Tokenizer implements StandardTokenizerConstants {
 ...
 */
  final public com.lucene.analysis.Token next() throws ParseException, IOException {
  Token token = null;
    ...
    default:
      ...
      if (token.kind == EOF) {
        ...
        {if (true) return
          new com.lucene.analysis.Token(token.image,
